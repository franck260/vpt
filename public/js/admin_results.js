$(document).ready(function() {
    ...
    $("#admin_results_link").click(function() {
        ...
        $("#tournament_results").load(/* url  */     "/admin/results?tournament_id=" + tournament_id,
                                      /* callback */ function() {
    ...
    $("#tournament_results").on("submit", "#admin_results_form", function() {
        ...
        $.post(/* url  */     "/admin/results",
               ...
               /* callback */ function(response) {
                                   ...
                                   $("#tournament_results").empty().append(response.results);
                                   $("#statistics_ajax_animation").hide();
                                   $("#results_ajax_animation").hide();

                                   if (response.statistics) {
                                       // Statistics in the response mean that the UPDATE is successful
                                       $("#tournament_statistics").empty().append(response.statistics);
